...
<script>
    const modalEditarPonto =
document.getElementById("modalEditarPonto");

const fecharEditarPonto =
document.getElementById("fecharEditarPonto");

document
.querySelectorAll(".btnEditarPonto")
.forEach(botao => {

    botao.addEventListener("click", function(){

        document.getElementById("editPontoId")
        .value = this.dataset.id;

        document.getElementById("editNumeroPonto")
        .value = this.dataset.numero;

        document.getElementById("editNomePonto")
        .value = this.dataset.nome;

        document.getElementById("editEnderecoPonto")
        .value = this.dataset.endereco;

        modalEditarPonto.style.display = "flex";

    });

});

fecharEditarPonto.onclick = function(){

    modalEditarPonto.style.display = "none";
